            ...
            <div class="adminbox">
                ...
                <div class="row mt-3 g-0 mx-3">
                    ...
                    <div class="col-6">
                        ...
                        " href="{{route('admin.receivables.summary', ['report' => $report, 'loan_type' => 'mpl'])}}">
                    ...
                    <div class="col-6">
                        ...
                        href="{{route('admin.receivables.summary', ['report' => $report, 'loan_type' => 'hsl'])}}">
                            ...
                            <tbody>
                                @foreach($units as $unit)
                                    <tr>
                                        ...
                                        <td class="text-center">{{$unit->members_count}}</td>
                                        <td class="text-center">{{ number_format($unitPayments[$unit->id]['principal_payments'], 2) }}</td>
                                        <td class="text-center">{{ number_format($unitPayments[$unit->id]['interest_payments'], 2) }}</td>
                                        <td class="text-center fw-bold">{{ number_format($unitPayments[$unit->id]['principal_payments'] + $unitPayments[$unit->id]['interest_payments'], 2) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
