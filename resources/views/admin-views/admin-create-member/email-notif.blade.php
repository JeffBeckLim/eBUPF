...
<body>
    <div class="container">
        ...
        <div>
            <p>
                Login using your <span style="font-weight: bold; color: #00638D;">BU email</span> and your temporary password is <span style="font-weight: bold; color: #00638D;">{{$password}}</span> <br> <br>
