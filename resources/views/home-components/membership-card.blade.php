        ...
        <div class="col ">
            <div class="row">
                ...
                <div class="col-lg-5  d-flex align-items-center">
                    <a style="padding-right: 100px" class="grow-on-hover btn bu-orange rounded-pill text-light fw-bold d-flex align-items-center" href="/member/membership-application/check/{{Auth::user()->member->id}}"><i class="fa fa-arrow-circle-right fa-lg pe-4" style="color: #b94703;"></i>See Membership Form</a>
